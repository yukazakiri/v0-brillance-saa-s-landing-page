...
export default function FooterSection({ settings }: FooterSectionProps) {
  ...
  const getSocialIcon = (platform: string) => {
    ...
    return (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="12" cy="12" r="10" stroke="#49423D" strokeWidth="2" fill="none"/>
      </svg>
    )
  }
        ...
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">
              {settings.shortTitle || settings.siteTitle || "Data Center College"}
            </div>
          </div>
          <div className="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans">
            {settings.tagline || "Empowering the next generation"}
          </div>
