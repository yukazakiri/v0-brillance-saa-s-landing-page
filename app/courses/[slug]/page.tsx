...
export default async function CoursePage({ params }: { params: { slug: string } }) {
  const [course, settings] = await Promise.all([fetchCourseBySlug(params.slug), fetchSettings()])
          ...
          <section className="relative overflow-hidden border-y border-border bg-card">
            ...
            <div className="relative z-10 px-4 sm:px-8 lg:px-12 py-12 flex flex-col gap-8 text-foreground">
              ...
              <div className="space-y-5 max-w-3xl">
                ...
                {course.credential && (
                  <p className="text-lg sm:text-xl text-muted-foreground font-semibold">{course.credential}</p>
                )}
                {course.summary && (
                  <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">{course.summary}</p>
                )}
              </div>
            ...
            <div className="flex-1 flex flex-col gap-8">
              ...
              {course.outcomes && course.outcomes.length > 0 && (
                <section className="bg-card border border-border rounded-lg p-6 md:p-8">
                  ...
                  <p className="text-muted-foreground mb-6">Graduates of this program can pursue careers in:</p>
                  <ul className="space-y-3">
                ...
                <div className="bg-muted/30 border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    {course.relatedOfferings.map((related) => (
                      ...
                      >
                        <h4 className="text-sm font-medium text-foreground hover:text-primary">{related.title}</h4>
                      </Link>
                    ))}
                  </div>
                </div>
