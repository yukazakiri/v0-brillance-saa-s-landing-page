...
export default function NewsPageContent({ articles, settings }: NewsPageContentProps) {
    ...
    return (
        <div className="w-full flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-[66px]">
                ...
                <div className="flex-1 border-l border-r border-[rgba(55,50,47,0.12)] py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8">
                    {!hasArticles ? (
                        <div className="text-center py-16">
                            ...
                            <p className="text-[#605A57] text-base sm:text-lg font-medium mb-2">No articles available</p>
                            <p className="text-[#605A57] text-sm">Check back soon for the latest news and announcements.</p>
                        </div>
                    ) : (
                        <>
                                                        ...
                                                        <div className="flex items-center gap-4 text-xs sm:text-sm text-[#605A57] mb-6">
                                                            ...
                                                            <span className="flex items-center gap-1.5">
                                                                ...
                                                                >
                                                                    ...
                                                                    <path d="M2 12c0-2.5 2-4 5-4s5 1.5 5 4" stroke="currentColor" strokeWidth="1" strokeLinecap="round" />
                                                                </svg>
                                                                {article.author}
                                                            </span>
                                                        </div>
                            ...
                            <div>
                                ...
                                {regularNews.length === 0 && selectedCategory !== "all" ? (
                                    <div className="text-center py-12">
                                        <p className="text-[#605A57] text-base">No articles found in this category.</p>
                                    </div>
                                ) : (
