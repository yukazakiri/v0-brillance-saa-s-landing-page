...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-screen w-64 sm:w-80 bg-card shadow-[0px_4px_24px_rgba(55,50,47,0.16)] z-50 flex flex-col transition-all duration-300 ease-out transform md:hidden ${
      ...
      <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[900px] lg:w-[900px] flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-[66px]">
        ...
        <section className="w-full border-b border-border py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 flex flex-col items-center gap-8">
        ...
        <section className="w-full border-b border-border py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8">
        ...
        <section className="w-full border-b border-border py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8">
        ...
        <section className="w-full border-b border-border py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8">
          <div className="max-w-[800px] mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              {[
                { icon: "🎯", title: "Excellence", description: "Committed to delivering the highest quality education and fostering academic achievement in every student." },
                { icon: "💡", title: "Innovation", description: "Embracing cutting-edge technology and modern teaching methodologies to prepare students for the future." },
                { icon: "🤝", title: "Community", description: "Building a supportive environment where students, faculty, and staff thrive together as one family." },
                { icon: "⭐", title: "Integrity", description: "Upholding ethical standards and fostering responsible leadership in all our endeavors and interactions." },
              ].map(value => (
                <div key={value.title} className="p-8 border border-border rounded-2xl hover:shadow-lg transition-all duration-300 bg-card">
                  <div className="text-4xl mb-4">{value.icon}</div>
                  <h3 className="text-foreground text-xl font-semibold font-sans mb-3">{value.title}</h3>
                  <p className="text-muted-foreground text-base leading-relaxed font-sans">{value.description}</p>
                </div>
              ))}
            </div>
          </div>
