      ...
      <div className="max-w-7xl mx-auto">
        ...
        {settings && (
          <>
                    ...
                    <div className="flex gap-4 mt-2">
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{
                            backgroundColor: settings.themeColors.primary,
                          }}
                        />
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className="w-12 h-12 rounded border-2 border-gray-300"
                          style={{
                            backgroundColor: settings.themeColors.secondary,
                          }}
                        />
                        <span className="text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className="w-12 h-12 rounded border-2 border-gray-300"
                          style={{
                            backgroundColor: settings.themeColors.accent,
                          }}
                        />
                        <span className="text-sm">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900">
                      {settings.institutionProfile.aboutTitle}
                    </p>
                  </div>
                  <div>
                    <span className="font-semibold text-gray-700">
                    ...
                    settings.institutionProfile.chedPrograms.length > 0 && (
                      <div>
                        ...
                        <div className="mt-2 space-y-3">
                          {settings.institutionProfile.chedPrograms.map(
                            (program, idx) => (
                              <div
                                key={idx}
                    ...
                    settings.institutionProfile.tesdaPrograms.length > 0 && (
                      <div>
                        ...
                        <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-3">
                          {settings.institutionProfile.tesdaPrograms.map(
                            (program, idx) => (
                              <div
                                key={idx}
            ...
            {/* Contact Directory */}
            {settings.contactDirectory &&
              settings.contactDirectory.length > 0 && (
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                  <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">
                    📞 Contact Directory
                  </h2>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <span
                      className={
                        settings.emergencyAlert.isActive
                          ? "text-red-600"
                          : "text-green-600"
                      }
                    >
        ...
        {!settings && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <p className="text-red-700">
              Unable to fetch settings. Please check your API configuration.
            </p>
          </div>
        )}
      </div>
