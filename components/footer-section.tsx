      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-foreground text-xl font-semibold leading-4 font-sans">Data Center College</div>
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          {/* Company Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-muted-foreground text-sm font-medium leading-5 font-sans">College</div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-foreground text-sm font-normal leading-5 font-sans cursor-pointer hover:text-primary transition-colors">
                Student Portal
              </div>
              <div className="self-stretch text-foreground text-sm font-normal leading-5 font-sans cursor-pointer hover:text-primary transition-colors">
                Library
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <div className="w-full h-full relative">
            {Array.from({ length: 400 }).map((_, i) => (
              <div
                key={i}
                className="absolute w-[300px] h-16 border border-border/50"
                style={{
                  left: `${i * 300 - 600}px`,
                  top: "-120px",
