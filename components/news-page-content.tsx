...
// Bento Grid Component for Facebook Images
function BentoGrid({ posts }: { posts: UnifiedPost[] }) {
          ...
          <div className="max-w-[1060px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 gap-4">
              ...
              <p className="text-[#605A57] text-lg font-light leading-relaxed max-w-2xl">
                Captured moments from our social media
              </p>
            </div>
...
export default function NewsPageContent({
  ...
  return (
    <div className="pt-16 sm:pt-20 flex flex-col justify-start items-center w-full relative overflow-hidden">
      ...
      {/* Bento Grid for Facebook Images */}
      <BentoGrid posts={facebookImages} />
    </div>
  );
}
