            ...
            <div className="relative z-10 px-4 sm:px-8 lg:px-12 py-12 flex flex-col gap-8 text-foreground">
              ...
              <div className="space-y-5 max-w-3xl">
                {course.code && (
                  <Badge
                    variant="outline"
                    className="tracking-[0.2em] text-xs font-mono"
                  >
                    {course.code}
                  </Badge>
                )}
          ...
          <div className="w-full flex flex-col lg:flex-row gap-8">
            <div className="flex-1 flex flex-col gap-8">
              ...
              {course.curriculumStructure &&
                course.curriculumStructure.length > 0 && (
                  <section className="bg-card border border-border rounded-lg p-6 md:p-8">
              ...
              {((course.prerequisites && course.prerequisites.length > 0) ||
                (course.prerequisiteNotes &&
                  course.prerequisiteNotes.length > 0)) && (
            ...
            <aside className="lg:w-[320px] flex flex-col gap-6">
              ...
              {/* Related Offerings */}
              {course.relatedOfferings &&
                course.relatedOfferings.length > 0 && (
